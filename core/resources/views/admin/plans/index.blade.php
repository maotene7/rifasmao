                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($methods as $method)
                                <tr>
                                    ...
                                    <td data-label="@lang('Processing Time')"> $ {{ $method->price }}</td>
                                    <td data-label="@lang('Processing Time')">  {{ $method->number_tickets }}</td>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="{{ route('admin.plans.method.edit', $method->id)}}"
